          ...
          allBooks.map((book) => (
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <button className="flex items-center justify-center text-green-700 w-10 h-10 bg-green-50 border border-green-200 rounded-xl hover:bg-green-600 hover:text-white transition-colors active:scale-95">
